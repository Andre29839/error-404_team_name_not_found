let e;var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},r={},i=t.parcelRequired9c8;null==i&&((i=function(e){if(e in a)return a[e].exports;if(e in r){var t=r[e];delete r[e];var i={id:e,exports:{}};return a[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},t.parcelRequired9c8=i),i("aER9F"),i("dd1Kv"),i("ge6e3"),i("itgY7"),i("7dfxV"),i("lSnTn"),i("hO2jc");var s=i("ge6e3");const{BASIC_URL:n,API_KEY:l,trending_week:o,new_films:d,movie_detailes:c}=s.refs,p={wrapper:document.querySelector(".month-wrapper"),addToLibraryBtn:document.querySelector('button[data-action="save"]'),container:document.querySelector(".container-img-weekly"),removeLibraryBtn:document.querySelector(".remove-from-library")};async function u(){try{let t=`${n}${d}?api_key=${l}`,a=await fetch(t),r=await a.json();if(0===r.results.length)return;let i=Math.floor(Math.random()*r.results.length);return[e=r.results[i]]}catch(e){console.log("Error fetching or rendering movies:",e),p.addToLibraryBtn.classList.add("visually-hidden"),p.wrapper.insertAdjacentHTML("afterbegin",'<p class="error-text">Oops...<br> Something went wrong.<br> Please try again later.</p>');return}}async function v(e){let t=`${n}${c}${e}?api_key=${l}`,a=await fetch(t),r=await a.json(),i=r.genres.slice(0,2).map(({name:e})=>e).join(", ");return i}p.addToLibraryBtn.addEventListener("click",function(){let t=e.id,a=JSON.parse(localStorage.getItem(s.LIBRARY_KEY))||[],r=a.findIndex(e=>e.id===t);r?(a.push(e),localStorage.setItem(s.LIBRARY_KEY,JSON.stringify(a)),p.addToLibraryBtn.classList.add("visually-hidden"),p.removeLibraryBtn.classList.remove("visually-hidden")):(a.splice(r,1),localStorage.setItem(s.LIBRARY_KEY,JSON.stringify(a)),p.addToLibraryBtn.classList.remove("visually-hidden"),p.removeLibraryBtn.classList.add("visually-hidden"))}),p.removeLibraryBtn.addEventListener("click",function(e){let t=e.currentTarget.dataset.action,a=JSON.parse(localStorage.getItem(s.LIBRARY_KEY))||[],r=a.findIndex(e=>e.id===Number(t));r&&(a.splice(r,1),localStorage.setItem(s.LIBRARY_KEY,JSON.stringify(a)),h(t))}),JSON.parse(localStorage.getItem(s.LIBRARY_KEY));let g=[];async function m(){let e=`${n}${o}?api_key=${l}`,t=await fetch(e),a=await t.json(),r=3;window.innerWidth<768?r=1:window.innerWidth>=768&&window.innerWidth<1280&&(r=3);let i=[];for(let e=0;e<r;e+=1){let e;do e=Math.floor(Math.random()*a.results.length);while(g.includes(a.results[e].id))g.push(a.results[e].id),i.push(a.results[e])}return i}async function y(e){let t="";for(let a of e){let{title:e,id:r,poster_path:i,release_date:s,overview:n,vote_average:l}=a,o=await v(r);t+=`<li class="movie-card open-modal" data-movie-id="${r}">
      ...
      <div class="rating-active" style="width:${10*l}%"></div>
         ...
         </li>`}p.container.insertAdjacentHTML("beforeend",t)}async function f(e){let t="";for(let a of e){let{title:e,id:r,backdrop_path:i,release_date:s,vote_average:n,vote_count:l,popularity:o,overview:d}=a,c=await v(r);t+=`<li data-id="${r}" class="js-card-month">
